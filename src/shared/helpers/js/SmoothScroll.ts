/* eslint-disable */
// @ts-nocheck
export function SmoothScrollControl() {
	//
	...
	let key = { left: 37, up: 38, right: 39, down: 40, spacebar: 32, pageup: 33, pagedown: 34, end: 35, home: 36 };
	...
	function isTouchpad(deltaY) {
		...
		let tp = !allDeltasDivisableBy(120) && !allDeltasDivisableBy(100) && !dpiScaledWheelDelta;
	...
	function SmoothScroll(optionsToSet) {
		for (let key in optionsToSet) if (defaultOptions.hasOwnProperty(key)) options[key] = optionsToSet[key];
	}
